		...
		<div class="block" id="tables">
			...
			<table class="list" width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr class="tr">
					...
					<td class="currency">
						<?php
						$actiondata[0] = array('contabilidade/controle_de_viagem_origem_destino/editar/'.$controle_de_viagem_origem->controle_de_viagem_origem_id, 'Editar', 'pencil.png' );
						$actiondata[1] = array('contabilidade/controle_de_viagem_origem_destino/excluir/'.$controle_de_viagem_origem->controle_de_viagem_origem_id, 'Excluir', 'cross.png' );
